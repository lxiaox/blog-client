<template>
  <div id="detail">
    <section class="user-info">
      ...
      <h3>前端异步大揭秘</h3>
      <p>
        <router-link to="/user">远岫</router-link>发布于3天前
      </p>
    </section>
    <section class="article">
      ...
      <p>
        ...
        <a href="https://css-tricks.com/snippets/css/a-guide-to-flexbox/" target="_blank">flexbox</a> 那样主要是一维系统。 你可以通过将CSS规则应用于父元素（成为网格容器）和该元素的子元素（网格元素），来使用网格布局。
      </p>
      <blockquote>
        <p>
          ...
          <a href="https://www.zhihu.com/people/jirengu-ruo-yu" target="_blank">远岫老师</a>翻译
        </p>
      </blockquote>
      <h2 id="引言">引言</h2>
      <p>
